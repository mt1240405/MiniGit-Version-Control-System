...
private:
    ...
    void SearchHistoryDfs(TreeNode *node, const string &pattern);
...
public:
    ...
    void SearchPatternHistory(const string &pattern);
    void PrintStatistics();
};

struct RecentFileComparator
{
    bool operator()(FileVersion *left, FileVersion *right) const;
};
